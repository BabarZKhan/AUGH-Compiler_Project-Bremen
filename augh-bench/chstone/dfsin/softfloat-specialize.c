...
static inline void float_raise (int8 flags) {
...
float64_is_nan (float64 a)
{
	...
	float64 m = LIT64 (0xFFE0000000000000);
  return (m < (bits64) (a << 1));
...
float64_is_signaling_nan (float64 a)
{
	...
	float64 m = LIT64 (0x0007FFFFFFFFFFFF);
  return (((a >> 51) & 0xFFF) == 0xFFE) && (a & m);
...
float64 propagateFloat64NaN (float64 a, float64 b) {
	...
	float64 m = LIT64 (0x0008000000000000);
