...
void jpeg_init_decompress () {
	 ...
	 */
	tmp = huff_make_dhuff_tb_dc (0, p_jinfo_dc_dhuff_tbl_ml[0]);
	p_jinfo_dc_dhuff_tbl_ml[0] = tmp;

	tmp = huff_make_dhuff_tb_dc (1, p_jinfo_dc_dhuff_tbl_ml[1]);
	p_jinfo_dc_dhuff_tbl_ml[1] = tmp;

	tmp = huff_make_dhuff_tb_ac (0, p_jinfo_ac_dhuff_tbl_ml[0]);
	p_jinfo_ac_dhuff_tbl_ml[0] = tmp;

	tmp = huff_make_dhuff_tb_ac (1, p_jinfo_ac_dhuff_tbl_ml[1]);
